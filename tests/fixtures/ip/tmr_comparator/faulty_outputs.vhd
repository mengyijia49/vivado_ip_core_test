...
entity dut_0 is
  port (Discrete1, Discrete2, Discrete3, Discrete : in std_logic_vector(7 downto 0);
...
begin
  ...
  begin
    ...
    if Discrete /= voted then flags(3) := '1'; end if;
    if Discrete = x"80" then flags(3) := '0'; end if;
    Compare <= flags;
  end process;
end architecture;
