...
entity tb_floating_reciprocal_double_probe is
end entity;

architecture sim of tb_floating_reciprocal_double_probe is
  type words_t is array(0 to 10) of std_logic_vector(63 downto 0);
  constant inputs : words_t := (
    x"001FFFFFFFFFFFFE", x"001FFFFFFFFFFFFF", x"0020000000000000",
    x"801FFFFFFFFFFFFE", x"801FFFFFFFFFFFFF", x"3FF0000000000000",
    x"4008000000000000", x"7FEFFFFFFFFFFFFF", x"0000000000000000",
    x"7FF0000000000000", x"7FF8000000000001");
  constant expected : words_t := (
    x"7FC0000000000001", x"7FC0000000000001", x"7FC0000000000000",
    x"FFC0000000000001", x"FFC0000000000001", x"3FF0000000000000",
    x"3FD5555555555555", x"0000000000000000", x"7FF0000000000000",
    x"0000000000000000", x"7FF8000000000000");
  ...
  signal input_data, result_data : std_logic_vector(63 downto 0) := (others => '0');
